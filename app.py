...
challenge_input  = st.text_input("Describe The Challenge You’re Dealing With ✍")
...
if challenge_input:
    ...
    st.success(f"You're facing: {challenge_input}. {random.choice(messages)}")
else:
    failure_messages = [
    ...
    st.warning(f"You're facing: {challenge_input}. {random.choice(failure_messages)}")


#reflexing
st.header("🔍Reflect on your progress🌱")
reflection_input = st.text_area("Write Your Reflection Here:")
...
if reflection_input:
    ...
    st.success(f"You're facing: {reflection_input}. {random.choice(success_reflection_msgs)}")
else:
    ...
    st.info(f"You're facing: {reflection_input}. {random.choice(failure_reflection_msgs)}")


#achievements
st.header("Celebrate Your Wins🏆✨")
achievement_input = st.text_input("Share Things You've Recently Accomplished:")
...
if achievement_input:
    ...
    st.success(f"You're facing: {achievement_input}. {random.choice(success_achievement_msgs)}")
else:
